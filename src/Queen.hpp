...
public:
	_Queen(bool colour, const short int* tileSize, sf::Vector2f boardPos, short int startx, short int starty) : _Piece<T>(colour, QUEEN, tileSize, boardPos, startx, starty) {
