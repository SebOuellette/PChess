...
public:
	_King(bool colour, const short int* tileSize, sf::Vector2f boardPos, short int startx, short int starty) : _Piece<T>(colour, KING, tileSize, boardPos, startx, starty) {
