...
// King class
template <typename T>
class King : public Piece<T> {
public:
	King(bool colour, const short int* tileSize, sf::Vector2f boardPos, short int startx, short int starty);
...
// Methods
template <typename T>
King<T>::King(bool colour, const short int* tileSize, sf::Vector2f boardPos, short int startx, short int starty) : Piece<T>(colour, KING, tileSize, boardPos, startx, starty) {}

template <typename T>
std::vector<sf::Vector2i> King<T>::getValidSquares(T * board) {
