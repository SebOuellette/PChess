...
public:
	_Knight(bool colour, const short int* tileSize, sf::Vector2f boardPos, short int startx, short int starty) : _Piece<T>(colour, KNIGHT, tileSize, boardPos, startx, starty) {
